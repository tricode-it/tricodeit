...
export default function Ecosistema() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between p-8 m-auto">
      <div className="md:w-1/2 mb-8 md:mb-0">
        <h1 className="text-4xl font-bold mb-4 text-gray-900">Integración perfecta con tu tecnología</h1>
      ...
      <div className="md:w-1/2 relative">
        <div className="w-[400px] h-[400px] relative">
          ...
          {Array.from({ length: outerCirclesCount }).map((_, index) => {
            ...
            const radiusVariation = Math.sin(index) * 20
            const x = Math.cos(angle) * (baseRadius + radiusVariation) + 200
            const y = Math.sin(angle) * (baseRadius + radiusVariation) + 200
